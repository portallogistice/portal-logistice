...
export function AboutSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      id="about" 
      className="relative py-24 sm:py-28 bg-gradient-to-b from-white via-gray-50/30 to-white dark:from-gray-950 dark:via-gray-900/30 dark:to-gray-950 overflow-hidden"
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-20">
          ...
          >
            <div className="space-y-6 text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
              <p className="relative pl-6 border-l-4 border-emerald-500 dark:border-emerald-400">
                {language === "ar"
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <div
                    key={index}
                    data-id={`stat-${index}`}
                    className={`group relative p-6 rounded-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-2 border-gray-200/50 dark:border-gray-800/50 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 text-center transition-all duration-1000 ${
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 mb-3 group-hover:scale-110 transition-transform shadow-lg">
                        <Icon className="w-6 h-6 text-white" />
                      </div>
                      <div className="text-3xl sm:text-4xl font-bold text-emerald-600 dark:text-emerald-400 mb-2 group-hover:scale-110 transition-transform">
                        {stat.value}
                      </div>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    ...
                    className={`group relative p-8 rounded-3xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-2 border-gray-200/50 dark:border-gray-800/50 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 overflow-hidden transition-all duration-1000 ${
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-5 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-xl`}>
                    ...
                    {/* Bottom accent */}
                    <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-b-3xl`} />
                  </div>
                );
              })}
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div
            data-id="vision"
            className={`group relative p-10 rounded-3xl bg-gradient-to-br from-emerald-50 via-white to-emerald-50/50 dark:from-emerald-950/40 dark:via-gray-900 dark:to-emerald-950/20 border-2 border-emerald-200/50 dark:border-emerald-900/50 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden transition-all duration-1000 ${
              visibleElements.has("vision") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
            style={{ transitionDelay: "800ms" }}
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-200/30 dark:bg-emerald-900/20 rounded-full blur-3xl opacity-50 group-hover:opacity-75 transition-opacity" />
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 mb-6 group-hover:scale-110 transition-transform shadow-xl">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">
                {language === "ar"
          ...
          <div
            data-id="mission"
            className={`group relative p-10 rounded-3xl bg-gradient-to-br from-blue-50 via-white to-blue-50/50 dark:from-blue-950/40 dark:via-gray-900 dark:to-blue-950/20 border-2 border-blue-200/50 dark:border-blue-900/50 hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden transition-all duration-1000 ${
              visibleElements.has("mission") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
            style={{ transitionDelay: "900ms" }}
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-200/30 dark:bg-blue-900/20 rounded-full blur-3xl opacity-50 group-hover:opacity-75 transition-opacity" />
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 mb-6 group-hover:scale-110 transition-transform shadow-xl">
