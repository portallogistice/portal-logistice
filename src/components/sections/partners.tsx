  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6 mb-20">
          {partners.map((partner, index) => {
            ...
            return (
              <a
                ...
                className={`group relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-3xl border-2 border-gray-200/50 dark:border-gray-800/50 hover:border-emerald-300 dark:hover:border-emerald-700 p-6 sm:p-8 flex flex-col items-center justify-center transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 overflow-hidden transition-all duration-1000 cursor-pointer ${
              ...
              >
                ...
                {/* Logo */}
                <div className="relative z-10 w-20 h-20 sm:w-24 sm:h-24 mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                  <PartnerLogo 
                    src={partner.logo} 
                ...
                {/* Partner Name */}
                <h3 className="relative z-10 text-base sm:text-lg font-bold text-gray-900 dark:text-white text-center group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                  {partner.name}
                </h3>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${stat.gradient} mb-6 group-hover:scale-110 transition-transform shadow-xl`}>
                    <Icon className="w-8 h-8 text-white" />
                  </div>
                  <div className={`text-4xl sm:text-5xl font-bold bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent mb-3 group-hover:scale-110 transition-transform`}>
                    {stat.value}
                  </div>
                  <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 font-medium group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">
                    {stat.label}
                  </p>
                </div>
              </div>
        ...
        <div className="text-center">
          <div 
            data-id="cta"
            className={`inline-block p-10 sm:p-12 rounded-3xl bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-600 text-white shadow-2xl border-2 border-emerald-400/20 backdrop-blur-sm transition-all duration-1000 ${
          ...
          >
            ...
            <p className="text-emerald-50 mb-8 max-w-xl mx-auto text-lg leading-relaxed">
              {language === "ar"
            ...
            <Link
              ...
              className="group relative inline-flex items-center gap-3 px-10 py-5 bg-white hover:bg-gray-50 text-emerald-600 font-bold text-lg rounded-2xl shadow-2xl hover:shadow-white/50 transition-all duration-300 transform hover:scale-105 overflow-hidden"
            >
